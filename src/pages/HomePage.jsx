...
function HomePage() {
  return (
    <div className="bg-gradient-to-b from-green-50 to-green-800  flex h-[100vh] flex-col items-center justify-center bg-stone-200 px-4">
      ...
      <p className=" animate__animated animate__bounceInLeft max-w-[700px] pb-7 text-center text-lg  text-green-950 font-mont font-[550]">
